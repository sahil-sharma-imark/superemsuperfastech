                    ...
                    <div class="login-grid search-grid">
                        <div class="search-inner-grid">
                            ...
                            <form>
                                ...
                                <div class="result">
                                    <h5>Result for 737856</h5>
                                </div>

                                <div class="d-flex status status-invalid">
                                    <h6>Warranty Status</h6> <span>Invalid</span>
                                </div>

                                <div class="btn-grid d-flex">
                                    <a class="btn btn-disable" href="#">Create Case</a>
                                    <a class="btn btnn" href="#">Make Another Search</a>
                                </div>
