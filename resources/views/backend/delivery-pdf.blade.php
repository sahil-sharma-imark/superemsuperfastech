    ...
    <body>
        <div class="main-pdf">
            <div class="pdf-header">
                <div class="top-head">
                    <h2>Delivery Order ID: {{$jobsheets->jobsheet_id}}</h2>
                    <figure>
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            @php $d_name=""; @endphp	
                            @endif
                                <p>Driver:<span> {{$d_name}}</span></p>
                            </td>
                            <td>
                                <p>Delivery Date:<span> {{$jobsheets->delivery_date}}</span></p>
                            </td>
                            <td>
            ...
            <div class="table-5">
                <table style="table-layout: fixed;">
                    <tbody>
                        <tr>
                            <td>
                                <p>Postal Code/Address:<span> {{$ro->site_address}}</span></p>
                            </td>
                        </tr>
                    </tbody>
                </table>
