				...
				@csrf
                    ...
                    <div class="row q_product{{$i}}">
                        <div class="col-lg-6">
                            <div class="form-group form-select-group w-100">
                                <label class="form-label">Product</label>
								<select class="form-select pro-select" aria-label="Default select example" name="product[]" disabled required>
								 <option value="">Select</option>
								 @foreach($products as $p)
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="quantity" name="quantity[]" class="form-control q_qty{{$i}}" onkeyup="q_qty({{$i}})" placeholder="5" value="{{$qty[$i]}}"required>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group form-select-group w-100">
				  ...
				  <div class="accordion-item">
                    ...
                    <div class="total-detail mt-5">
						 ...
						 <input type="text" class="form-control"id="total_price" name="totalprice">
						 </div>
                        <div class="form-group">
                            <label class="form-label">Rebates:</label>
                            <input type="text" name="rebates" id="rebates" class="form-control" placeholder="10%">
                        </div>
						<div class="form-group" style="margin-bottom: 10px;">
						 <label class="form-label">Final amount without GST:</label>
						 <input type="text" class="form-control"id="final" name="final" style="max-width: 126px;">
						 </div>
