...
$(services).on("keyup", function(e) {alert("dfd");
        ...
        <div class="box-shadow role">
            ...
            <div class="form mw-100">
				...
				@csrf
                    <div class="row row-cols-md-2 row-cols-1">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="number" name="ro" class="form-control" placeholder="5954484" value="{{$quotations->ro_number}}" id="ro" required>
                            </div>
                        </div>
                        <div class="col">
						@php 
                            ...
                            <div class="form-group form-select-group w-100">
                                ...
                                <div class="search-it">
                                    ...
                                    <select class="form-select" aria-label="Default select example" name="owner" id="owner"required>
                                        ...
                                        <option value="{{$com->id}}" @if($quotations->company==$com->id) selected @endif>{{$com->company_name}}</option>
										@endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row row-cols-md-5 row-cols-2 align-items-end">
                        <div class="col">
                            <div class="form-group form-select-group w-100">
                    ...
                    <div class="prices total-detail">
                        <div class="s-total d-flex justify-content-between">
                            ...
                            <input type="text" name="subtotal" id="total_price" value="{{$quotations->subtotal}}" style="border: none;text-align: right;">
                        </div>
                        <div class="s-total d-flex justify-content-between">
                            <div class="form-group">
